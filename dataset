...
class MicroVideoDataset(Dataset):
    """시청 시퀀스 기반 Dataset"""
    def __init__(self, interactions_df, max_seq_len=50, mode='train'):
        ...
        self.num_items = interactions_df['video_id'].max() + 2
